...
app_indicator_category_get_type (void)
{
	...
	if (G_UNLIKELY(etype == 0)) {
		static const GEnumValue values[] = {
			{ APP_INDICATOR_CATEGORY_APPLICATION_STATUS,  "APP_INDICATOR_CATEGORY_APPLICATION_STATUS", "application-status" },
			{ APP_INDICATOR_CATEGORY_COMMUNICATIONS,  "APP_INDICATOR_CATEGORY_COMMUNICATIONS", "communications" },
			{ APP_INDICATOR_CATEGORY_SYSTEM_SERVICES,  "APP_INDICATOR_CATEGORY_SYSTEM_SERVICES", "system-services" },
...
app_indicator_status_get_type (void)
{
	...
	if (G_UNLIKELY(etype == 0)) {
		static const GEnumValue values[] = {
			...
			{ APP_INDICATOR_STATUS_ATTENTION,  "APP_INDICATOR_STATUS_ATTENTION", "attention" },
			{ 0, NULL, NULL}
		};
